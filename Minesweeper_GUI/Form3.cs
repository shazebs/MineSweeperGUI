...
namespace Minesweeper_GUI
{
    public partial class Form3 : Form
    {
        ...
        string filePath = @"C:\Users\shaze\source\CST-250\Minesweeper_GUI_2\Minesweeper_GUI\HighScores.txt";
        ...
        private void saveAllScoresToFile()
        {
            ...
            foreach (GameStats stat in stats){
                lines.Add($"{stat.PlayerName}|{stat.GameSeconds}|{stat.BoardSize}|{stat.TotalBombs}|{stat.GameScore}|{stat.WinLoss}"); 
            }
                ...
                foreach (string line in lines) {
                    try {
                        ...
                        GameStats newStats = new GameStats(
                                    ...
                                    bool.Parse(tokens[5].Trim())    // win/loss
                                );
