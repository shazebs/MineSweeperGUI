    ...
    public partial class Form1 : Form
    {
        ...
        public void checkForEndOfGame(bool gameLost)
        {
            if (gameLost)
            {
                ...
                todayScores.Add(new GameStats(PlayerName, parseTime(), lineOfCells, board.totalBombs, localScore, false));

                // Open form3 after game ends. 
                /*Form3 f3 = new Form3(this, todayScores);
                f3.ShowDialog();*/
            }
            else // game is not yet over
            {
                ...
                if (board.isGameWon() && clickable)
                {
                    ...
                    todayScores.Add(new GameStats(PlayerName, parseTime(), lineOfCells, board.totalBombs, localScore, true));
        ...
        {
            // Open form3. 
            Form3 f3 = new Form3(this, todayScores); // create a form3 object 
